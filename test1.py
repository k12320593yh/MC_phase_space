...
def eeeegamma(vectors,masses=[0,0,0]):
    p = np.vstack((np.array([[0,0,0,0],[5000,0,0,5000],[5000,0,0,-5000]]),vectors))
    ...
    # print(s)
    # print(s_)
    return [coefficient*T*S,p1,p2,p3,p4,p5]
...
print('!')
print('bb')
print(mc.phase_space_integration(eeeegamma,number_of_dots=10000,s_sqrt=10,masses=[0,0,0],dimension=3))
